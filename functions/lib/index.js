            ...
            const newPoints = await db.runTransaction(async (transaction) => {
                ...
                if (idemKey) {
                    ...
                    if (idemSnap.exists) {
                        ...
                        return typeof (stored === null || stored === void 0 ? void 0 : stored.newPoints) === 'number' ? stored.newPoints : (userData.points || 0);
                    }
                }
                for (const cartItem of cart) {
                    ...
                    if (directSnap.exists) {
                        ...
                        resolvedName = data === null || data === void 0 ? void 0 : data.name;
                        resolvedPrice = typeof (data === null || data === void 0 ? void 0 : data.price) === 'number' ? data.price : undefined;
                    }
                    else {
                        ...
                        resolvedPrice = typeof (optData === null || optData === void 0 ? void 0 : optData.price) === 'number' ? optData.price : undefined;
                        ...
                        if (baseRef) {
                            ...
                            const baseName = (baseData === null || baseData === void 0 ? void 0 : baseData.name) || '상품';
                            resolvedName = `${baseName} ${(optData === null || optData === void 0 ? void 0 : optData.name) || ''}`.trim();
                        }
                        else {
                            resolvedName = (optData === null || optData === void 0 ? void 0 : optData.name) || '옵션';
                        }
                    }
            ...
            if (productData.options && Array.isArray(productData.options)) {
                const updatedOptions = productData.options.map((option) => {
                    if (option.price && option.price < 0) {
                        needsUpdate = true;
                        return Object.assign(Object.assign({}, option), { price: Math.abs(option.price) });
                    }
                    return option;
                });
                if (needsUpdate) {
